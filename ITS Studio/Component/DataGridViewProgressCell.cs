    ...
    internal class DataGridViewProgressCell : DataGridViewImageCell
    {
            ...
            DataGridViewPaintParts paintParts)
        {
            if (value == null)
                ...
                value = 0;
            else if (Convert.ToInt16(value) == 0)
                value = 0;
            ...
            if (percentage >= 0.0)
            {
                ...
                g.FillRectangle(new SolidBrush(_ProgressBarColor), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width * 1)), cellBounds.Height / 1 - 5);
                //Draw text
